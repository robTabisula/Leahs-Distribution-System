...
<html>
  ...
  <body>
        ...
        //query for issuance table
              $queryit = "INSERT INTO issuance (issue_id, issue_date_time, client_id, issue_type, remarks) 
                             VALUE ('$issue_id','$issue_date_time','$clientlist','$choice','$remarks')";
					   ...
					   foreach ( $mi as $value ){
							...
							//query for issuance list
									 $queryil = "INSERT INTO issuance_list (issue_id, prod_qty, prod_price, branch, prod_id, remarks) 
											   VALUE ('$issue_id','$qty','$adjprice','$branch','$product','$p_remarks')";
