...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 16, 2017 at 08:53 PM
...
(235, 'Baguio', 'Enabled', '1.5', ''),
(235, 'Pangasinan', 'Enabled', '1.5', ''),
(236, 'Baguio', 'Enabled', '150', ''),
(236, 'Pangasinan', 'Enabled', '150', ''),
(237, 'Baguio', 'Enabled', '20', ''),
(237, 'Pangasinan', 'Enabled', '20', ''),
(236, 'Baguio', 'Disabled', '160', ''),
(236, 'Pangasinan', 'Disabled', '160', '');
...
--
ALTER TABLE `inventory`
  MODIFY `iS_inventoryid` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;
--
...
--
ALTER TABLE `product_list`
  MODIFY `productList_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=239;
--
