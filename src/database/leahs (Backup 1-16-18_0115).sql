...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Jan 15, 2018 at 05:14 PM
...
(272, 'TEST PRODUCT 1.5(gm(s))(gm(s))', 50, 'gm(s)', 13, 1111),
(273, 'Test Product 5(gm(s))', 750, 'gm(s)', 23, 1012121),
(274, 'Test Product 5.1(gm(s))(gm(s))', 65, 'gm(s)', 21, 111111111);
