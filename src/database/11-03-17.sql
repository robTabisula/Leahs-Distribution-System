...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 03, 2017 at 03:18 PM
...
INSERT INTO `logs` (`logs_id`, `acc_id`, `act`, `date_time`, `related_id`, `remarks`) VALUES
(1, 1, 'login', '2017-10-28 01:23:25.000000', NULL, 'has successfully login'),
(3, 1, 'login', '2017-10-28 01:25:00.000000', NULL, 'has successfully login'),
(5, 1, 'login', '2017-10-28 01:26:52.000000', NULL, 'has successfully login'),
(8, 1, 'login', '2017-10-28 02:19:14.000000', NULL, 'has successfully login'),
(17, 1, 'login', '2017-11-03 15:07:38.000000', NULL, 'has successfully login');
...
--
ALTER TABLE `issuance`
  MODIFY `issue_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
--
...
--
ALTER TABLE `logs`
  MODIFY `logs_id` int(15) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
--
